...
// This simple script operates once every five seconds, detecting any grids further than whatever the variable "madRange" is set to, and marking them to be deleted.
...
namespace IndustrialAutomaton.WorldBorderEnforcement
{
    ...
    public class WorldBorderEnforcementBase : MySessionComponentBase
    {
		...
		public static Vector3D origin = new Vector3D(-46792.9675037454,-67809.779394819139,-76150.667452344554);
		...
		public override void UpdateBeforeSimulation()
		{
			...
			foreach (var ent in entList)
				if ( (int)Vector3D.Distance(ent.GetPosition(), origin) > maxRange * 1000)
					gridList.Add(ent);
